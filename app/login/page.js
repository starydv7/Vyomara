        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-2 rounded-2xl border border-slate-200/70 bg-slate-50/50 p-1 dark:border-slate-700 dark:bg-slate-900/30">
            <button
              ...
              className={`flex-1 rounded-xl px-4 py-2.5 text-sm font-semibold transition ${loginMethod === 'email'
            ...
            <button
              ...
              className={`flex-1 rounded-xl px-4 py-2.5 text-sm font-semibold transition ${loginMethod === 'phone'
                  ? 'bg-white text-rose-600 shadow-sm dark:bg-slate-800 dark:text-rose-400'
                  : 'text-slate-600 hover:text-rose-600 dark:text-slate-300'
                }`}
            >
          ...
          {loginMethod === 'email' ? (
            <div className="space-y-1">
              ...
              <input
                ...
                className={`w-full rounded-2xl border px-4 py-3 text-sm text-slate-700 shadow-sm transition focus:outline-none focus:ring-2 ${errors.email
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-2xl border px-4 py-3 pl-14 text-sm text-slate-700 shadow-sm transition focus:outline-none focus:ring-2 ${errors.phone
                      ? 'border-red-400 focus:border-red-400 focus:ring-red-100 dark:border-red-500 dark:focus:ring-red-900/40'
                      : 'border-slate-200/80 bg-white/90 focus:border-rose-400 focus:ring-rose-100 dark:border-slate-700 dark:bg-slate-900/60 dark:text-white dark:focus:border-rose-500'
                    }`}
                />
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-2xl border px-4 py-3 pr-12 text-sm text-slate-700 shadow-sm transition focus:outline-none focus:ring-2 ${errors.password
                    ? 'border-red-400 focus:border-red-400 focus:ring-red-100 dark:border-red-500 dark:focus:ring-red-900/40'
                    : 'border-slate-200/80 bg-white/90 focus:border-rose-400 focus:ring-rose-100 dark:border-slate-700 dark:bg-slate-900/60 dark:text-white dark:focus:border-rose-500'
                  }`}
              />
...
function RoleCard({ label, description, active, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex flex-1 min-w-[260px] flex-col items-start gap-2 rounded-2xl border p-4 text-left transition ${active
